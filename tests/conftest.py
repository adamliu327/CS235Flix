...
TEST_DATA_PATH_MEMORY = os.path.join('D:', os.sep, 'PycharmProjects', 'CS235Flix', 'tests', 'data', 'memory')
TEST_DATA_PATH_DATABASE = os.path.join('D:', os.sep, 'PycharmProjects', 'CS235Flix', 'tests', 'data', 'database')
